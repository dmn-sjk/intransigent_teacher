...
def get_transform(dataset_name: str, adaptation: str, preprocess: Union[transforms.Compose, None], losstest_type=None):
    """
    ...
    """
    if adaptation == "adacontrast" or losstest_type == 'contrastive_ada':
        # adacontrast requires specific transformations
        if dataset_name in ["cifar10", "cifar100", "cifar10_c", "cifar100_c", "cifar10_1"]:
        ...
        if dataset_name in ["cifar10", "cifar100", "cifar10_1"]:
...
def get_test_loader(setting: str, adaptation: str, dataset_name: str, preprocess: Union[transforms.Compose, None],
                    ...
                    losstest_type: str = None, ckpt_path: str = None):
    """
    ...
    transform = get_transform(dataset_name, adaptation, preprocess, losstest_type=losstest_type)
    ...
    if domain_name == "none":
        ...
        elif dataset_name in ["imagenet_r"]:
            test_dataset = torchvision.datasets.ImageFolder(root=data_dir, transform=transform)

        elif dataset_name == "ccc":
            # url = os.path.join('/net/pr2/projects/plgrid/plgguseby/CCC/baseline_20_transition+speed_1000_seed_44', "serial_{00000..99999}.tar") # Uncoment this to use a local copy of CCC
...
def get_source_loader(dataset_name: str, adaptation: str, preprocess: Union[transforms.Compose, None],
    ...
    if dataset_name in ["cifar10", "cifar10_c"]:
        source_dataset = torchvision.datasets.CIFAR10(root=data_root_dir,
                                                      ...
                                                      download=True,
                                                      transform=transform)
    elif dataset_name in ["imagenet", "imagenet_c", "ccc"]:
